...
import dev.maximerix.tuffblocks.block.custom.ModStairsBlock;
...
public class ModBlocks {
    public static final Block TUFF = registerBlock("tuff",
            new Block(FabricBlockSettings.of(Material.STONE)
                    .materialColor(MapColor.TERRACOTTA_GRAY)
                    .strength(1.5f, 6f)
                    .sounds(ModSounds.TUFF_SOUNDS)
                    .requiresTool()));
    public static final Block TUFF_STAIRS = registerBlock("tuff_stairs",
            new ModStairsBlock(TUFF.getDefaultState(),
    ...
    public static final Block POLISHED_TUFF_STAIRS = registerBlock("polished_tuff_stairs",
            new ModStairsBlock(POLISHED_TUFF.getDefaultState(),
                    FabricBlockSettings.of(Material.STONE)
                            .materialColor(MapColor.TERRACOTTA_GRAY)
                            .strength(1.5f, 6f)
                            .sounds(ModSounds.POLISHED_TUFF_SOUNDS)
    ...
    public static final Block TUFF_BRICK_STAIRS = registerBlock("tuff_brick_stairs",
            new ModStairsBlock(TUFF_BRICKS.getDefaultState(),
                    FabricBlockSettings.of(Material.STONE)
                            .materialColor(MapColor.TERRACOTTA_GRAY)
                            .strength(1.5f, 6f)
                            .sounds(ModSounds.TUFF_BRICKS_SOUNDS)
