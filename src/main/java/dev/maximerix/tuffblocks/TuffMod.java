...
public class TuffMod {
	...
	public TuffMod() {
		...
		TuffBlocks.BLOCKS.register(bus);
		TuffItems.ITEMS.register(bus);
		TuffSounds.SOUND_EVENTS.register(bus);

		bus.addListener(this::commonSetup);
		MinecraftForge.EVENT_BUS.register(this);
		MinecraftForge.EVENT_BUS.addListener(TuffWorldGen::generateOres);
	}

	private void commonSetup(final FMLCommonSetupEvent event) {
		event.enqueueWork(TuffWorldGen::init);
