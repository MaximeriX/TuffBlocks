...
public class TuffSoundTypes {
    public static final ForgeSoundType TUFF = new ForgeSoundType(
            1.0f, 1.0f,
            () -> TuffSounds.BLOCK_TUFF_BREAK.get(),
            () -> TuffSounds.BLOCK_TUFF_STEP.get(),
            () -> TuffSounds.BLOCK_TUFF_PLACE.get(),
            () -> TuffSounds.BLOCK_TUFF_HIT.get(),
            () -> TuffSounds.BLOCK_TUFF_FALL.get()
    );
