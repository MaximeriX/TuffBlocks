...
public class TuffSounds {
	public static final DeferredRegister<SoundEvent> SOUND_EVENTS =
			new DeferredRegister<>(ForgeRegistries.SOUND_EVENTS, TuffMod.MODID);

	public static final RegistryObject<SoundEvent> BLOCK_TUFF_BREAK = register("block.tuff.break");
	public static final RegistryObject<SoundEvent> BLOCK_TUFF_PLACE = register("block.tuff.place");
	public static final RegistryObject<SoundEvent> BLOCK_TUFF_HIT = register("block.tuff.hit");
	public static final RegistryObject<SoundEvent> BLOCK_TUFF_FALL = register("block.tuff.fall");
	public static final RegistryObject<SoundEvent> BLOCK_TUFF_STEP = register("block.tuff.step");
