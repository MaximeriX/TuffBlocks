...
public class BlockTuffSlab extends ElementsTuffBlocks.ModElement {
	@GameRegistry.ObjectHolder("tuff:tuff_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("tuff:tuff_slab_double")
	public static final Block block_slab_double = null;
	public BlockTuffSlab(ElementsTuffBlocks instance) {
		super(instance, 3);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("tuff:tuff_slab", "inventory"));
	}
