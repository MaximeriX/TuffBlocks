...
public class TuffBricksBlock extends TuffModElements.ModElement {
	@ObjectHolder("tuff:tuff_bricks")
	public static final Block block = null;

	public TuffBricksBlock(TuffModElements instance) {
		super(instance, 10);
	}
