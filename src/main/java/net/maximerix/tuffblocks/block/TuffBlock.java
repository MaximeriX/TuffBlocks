...
public class TuffBlock extends TuffModElements.ModElement {
	@ObjectHolder("tuff:tuff")
	public static final Block block = null;

	public TuffBlock(TuffModElements instance) {
		super(instance, 1);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("tuff:tuff_match"), () -> CustomRuleTest.codec);
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 30)).range(20)
					.square().func_242731_b(3);
			event.getRegistry().register(feature.setRegistryName("tuff"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tuff:tuff"), configuredFeature);
		}
	}
