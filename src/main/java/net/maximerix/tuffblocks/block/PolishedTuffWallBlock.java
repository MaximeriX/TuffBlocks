...
public class PolishedTuffWallBlock extends TuffModElements.ModElement {
	@ObjectHolder("tuff:polished_tuff_wall")
	public static final Block block = null;

	public PolishedTuffWallBlock(TuffModElements instance) {
		super(instance, 9);
	}
