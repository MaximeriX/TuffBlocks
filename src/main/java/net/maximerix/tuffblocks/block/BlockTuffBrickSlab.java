...
public class BlockTuffBrickSlab extends ElementsTuffBlocks.ModElement {
	@GameRegistry.ObjectHolder("tuff:tuff_brick_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("tuff:tuff_brick_slab_double")
	public static final Block block_slab_double = null;
	public BlockTuffBrickSlab(ElementsTuffBlocks instance) {
		super(instance, 12);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tuff_brick_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("tuff_brick_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("tuff:tuff_brick_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("tuff_brick_slab");
