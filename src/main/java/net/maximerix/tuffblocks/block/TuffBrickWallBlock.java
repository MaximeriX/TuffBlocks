...
public class TuffBrickWallBlock extends TuffModElements.ModElement {
	@ObjectHolder("tuff:tuff_brick_wall")
	public static final Block block = null;

	public TuffBrickWallBlock(TuffModElements instance) {
		super(instance, 13);
	}
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					.sound(new ForgeSoundType(1.0f, 1.0f,
							...
							() -> new SoundEvent(new ResourceLocation("tuff:block.tuff_bricks.step"))))
					.hardnessAndResistance(1.5f, 6f).setLightLevel(s -> 0).harvestLevel(0).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("tuff_brick_wall");
		}
