...
public class BlockPolishedTuffSlab extends ElementsTuffBlocks.ModElement {
	@GameRegistry.ObjectHolder("tuff:polished_tuff_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("tuff:polished_tuff_slab_double")
	public static final Block block_slab_double = null;
	public BlockPolishedTuffSlab(ElementsTuffBlocks instance) {
		super(instance, 8);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("polished_tuff_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("polished_tuff_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("tuff:polished_tuff_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("polished_tuff_slab");
